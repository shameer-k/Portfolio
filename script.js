...
ScrollReveal({
   ...
   ScrollReveal().reveal('.homeImg img, .servicesContainer, .protfolioBox, .testimonialWrapper, .contact form', { origin: 'bottom' });
   ScrollReveal().reveal('.homeContent h1, .aboutImg img', { origin: 'left' });
